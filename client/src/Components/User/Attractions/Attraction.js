...
function Attraction() {
  ...
  let attraction = 'Chowmahalla Palace';
  let description =
  ...
  return (
    <>
      ...
      <div className={classes.about}>
        <Text text='About' />
        <Text text={attraction} color='black' />
      </div>
      ...
      <div className={classes.attractions}>
        <div style={{ display: 'flex' }}>
          <Text text='Nearby   ' />
          <Text text='Attractions ' color='black' />
        </div>
      ...
      <div className={classes.attractions}>
        <div style={{ display: 'flex' }}>
          <Text text='Nearby  ' />
          <Text text='Restaurants' color='black' />
        </div>
        <div className={classes.subCarousel}>
          <SubCarousel />
        </div>
